enyo.kind({
	...
	components: [{
		...
		components: [{
			...
			ontap: "itemTap", 
			components: [
				{name: "thumbnail", kind: "Image", classes: "foreplot-item-thumbnail"},
				{name: "title", classes: "foreplot-item-title"},
				{name: "description", classes: "foreplot-item-description"}
			]
		}]
	},{
		name: "articleSearch", kind: "Foreplot.ArticleSearch", onResults: "searchResults"
	}],
